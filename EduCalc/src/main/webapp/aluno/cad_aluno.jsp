            ...
            <div class="conteudo">
                ...
                <form name="frmAluno" action="<%=request.getContextPath()%>/cria_aluno" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="matricula" placeholder="Matrícula" class="caixa2" maxlength="6"
                            required oninput="this.value = this.value.replace(/[^0-9]/g, '')" inputmode="numeric">

                        <input type="text" name="idade" placeholder="Idade" class="caixa2" maxlength="3" required
